...
var starImg , starImg2 ;
var star , star2;

var emptyStarImg,starsImg,oneStarImg;
var starDisplay;
...
function preload()
{
  ...
  //gStarImg = loadAnimation('g_star1.png');
...
function setup() 
{
  ...
  starDisplay.addAnimation('empty',emptyStarImg);
  starDisplay.addAnimation('one',oneStarImg);
  starDisplay.addAnimation('two',starsImg);
